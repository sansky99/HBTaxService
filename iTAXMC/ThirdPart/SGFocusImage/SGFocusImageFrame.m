...
//    NSLog(@"_pageControl:%f,%f,%f,%f", _pageControl.frame.origin.x, _pageControl.frame.origin.y, _pageControl.frame.size.width, _pageControl.frame.size.height);
    _pageControl.frame = CGRectMake(self.frame.size.width - _pageControl.frame.size.width - 20, _pageControl.frame.origin.y, _pageControl.frame.size.width, _pageControl.frame.size.height);
//    NSLog(@"_pageControl:%f,%f,%f,%f", _pageControl.frame.origin.x, _pageControl.frame.origin.y, _pageControl.frame.size.width, _pageControl.frame.size.height);
...
//    NSLog(@"click button tag is %ld",(long)sender.tag);
    ...
    {
        NSArray *imageItems = objc_getAssociatedObject(self, (const void *)SG_FOCUS_ITEM_ASS_KEY);
        [self.delegate performSelector:@selector(foucusImageFrame:didSelectItem:) withObject:self withObject:[imageItems objectAtIndex:(long)sender.tag]];
    }
}
