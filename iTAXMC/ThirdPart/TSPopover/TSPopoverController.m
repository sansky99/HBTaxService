...
#define MARGIN 1        //5
#define OUTER_MARGIN 1      //5
#define TITLE_LABEL_HEIGHT 0        //25
#define ARROW_SIZE 0        //20
        ...
        if(!arrowDirection){
            ...
            if(clearSpaceA> clearSpaceB){
                if(clearSpaceA < titleLabelheight+10){
                    ...
                    CGRect rtTableView = _contentViewController.view.bounds;
                    if (clearSpaceB >= titleLabelheight + rtTableView.size.height)
