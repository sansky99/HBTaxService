...
- (void)setBadgeText:(NSString *)badgeText
{
    if (badgeText != _badgeText)
    {
        ...
        //14-6-20	partially refresh problem
//        [self setNeedsDisplay];
        [self setNeedsLayout];
    }
}
    ...
    if (anyTextToDraw)
    {
        ...
        CGContextSaveGState(ctx);
        {
			...
			else
			{
				...
				NSDictionary *dict = @{NSForegroundColorAttributeName:self.badgeTextColor, NSFontAttributeName : self.badgeTextFont, NSParagraphStyleAttributeName: ps};
