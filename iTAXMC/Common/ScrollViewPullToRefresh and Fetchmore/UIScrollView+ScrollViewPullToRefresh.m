//
//  UIScrollView+ScrollViewPullToRefresh.m
//  iTAXMC
//
...
#import "UIScrollView+ScrollViewPullToRefresh.h"
...
- (void)loadLayer
{
    ...
    self.track_layer.fillColor    = [UIColor clearColor].CGColor;
    self.track_layer.strokeColor  = [UIColor whiteColor].CGColor;
    self.track_layer.lineCap       = kCALineCapRound;
    
//    self.track_layer.frame         = self.bounds;
//    
//    self.track_layer.strokeEnd     = 1;
//    self.track_layer.shadowColor   = [UIColor colorWithWhite:1 alpha:0.8].CGColor;
//    self.track_layer.shadowOpacity = 0.7;
//    self.track_layer.shadowRadius  = 20;
//    self.track_layer.contentsScale = [UIScreen mainScreen].scale;
//    
...
#pragma mark -
#pragma mark -  SYPullToRefreshView
...
@implementation SYPullToRefreshView
...
#pragma mark -
#pragma mark -SYPullToRefreshView init
...
#pragma mark -
#pragma mark - UIScrollView (SYScrollViewPullToRefresh)
...
@implementation UIScrollView (ScrollViewPullToRefresh)

@dynamic date_key;
@dynamic pull_to_refresh_view;

- (void)setPull_to_refresh_view:(SYPullToRefreshView *)pull_to_refresh_view
{
...
- (SYPullToRefreshView *)pull_to_refresh_view
{
...
- (void)setPullStartBlock:(PullStartBlock)pull_start_block
{
    if(nil == self.pull_to_refresh_view)
    {
        self.pull_to_refresh_view = [[SYPullToRefreshView alloc] initWithFrame:CGRectMake(0.0f,
                                                                                          -PULL_HEIGHT,
