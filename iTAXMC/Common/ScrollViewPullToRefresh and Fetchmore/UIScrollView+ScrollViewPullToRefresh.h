//
//  UIScrollView+ScrollViewPullToRefresh.h
//  iTAXMC
//
...
@class SYPullToRefreshView;

@interface UIScrollView (ScrollViewPullToRefresh)

@property (readonly, strong, nonatomic) SYPullToRefreshView *pull_to_refresh_view;
...
@interface SYPullToRefreshView : UIView
